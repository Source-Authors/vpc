...
class CUtlString {
 ...
 public:
  ...
  inline friend bool operator==(const char *lhs, const CUtlString &rhs) {
  ...
  // Strips off one directory. Uses V_StripLastDir but strips the last slash
  // also!
