...
#ifndef VPC_TIER1_UTLSYMBOL_H_
#define VPC_TIER1_UTLSYMBOL_H_
...
class CUtlSymbolTable {
 public:
  // constructor, destructor
  CUtlSymbolTable(int growSize = 0, int initSize = 16,
 ...
 protected:
  ...
  class CLess {
   public:
    CLess(int = 0) {}  // permits default initialization to NULL in CUtlRBTree
...
//
// NOTE:  You can't pass these objects between .dlls in an interface (also true
// of CUtlSymbol of course)
//
