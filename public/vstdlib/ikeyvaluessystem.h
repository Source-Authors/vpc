...
#ifndef VPC_VSTDLIB_IKEYVALUESSYSTEM_H_
#define VPC_VSTDLIB_IKEYVALUESSYSTEM_H_
...
class IKeyValuesSystem {
 public:
  ...
  virtual void RegisterSizeofKeyValues(size_t size) = 0;

  // allocates/frees a KeyValues object from the shared mempool
  virtual void *AllocKeyValuesMemory(size_t size) = 0;
...
#endif  // VPC_VSTDLIB_IKEYVALUESSYSTEM_H_
