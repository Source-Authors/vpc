...
bool CProjectGenerator_Win32_2010::WriteFile(CProjectFile *pFile,
...
bool CProjectGenerator_Win32_2010::WriteFolder(CProjectFolder *pFolder,
                                               const char *pFileTypeName,
                                               int nDepth) {
  if (!nDepth) {
...
bool CProjectGenerator_Win32_2010::WriteConfiguration(
...
bool CProjectGenerator_Win32_2010::WritePrimaryXML(
...
bool CProjectGenerator_Win32_2010::WriteFolderToSecondaryXML(
...
bool CProjectGenerator_Win32_2010::WriteFileToSecondaryXML(
...
bool CProjectGenerator_Win32_2010::WriteFolderContentsToSecondaryXML(
...
bool CProjectGenerator_Win32_2010::WriteSecondaryXML(
    const char *pOutputFilename) {
...
bool CProjectGenerator_Win32_2010::WriteTool(const char *pToolName,
...
bool CProjectGenerator_Win32_2010::WriteProperty(
  ...
  switch (pPropertyState->m_pToolProperty->m_nType) {
    ...
    default:
      g_pVPC->VPCError(
          "CProjectGenerator_Win32_2010: WriteProperty, %s - not implemented",
          pOutputName);
  }
